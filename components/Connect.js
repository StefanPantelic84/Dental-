  ...
  return (
    <div className='connect-container'>
      <div className='connect-text'>
        ...
        <p>SMATRAMO DA ZASLUŽUJETE NAJBOLJE STOMATOLOŠKO ISKUSTVO. POZOVITE <a href='tel:+381606788761'>(+381)60/6788761</a> ILI ZATRAŽITE ONLINE SASTANAK DA ZAKAŽETE SVOJU PRVU POSETU. RADUJEMO SE NAŠEM SUSRETU!</p>
        <div className='connect-call'><a href="https://www.instagram.com/milosevicdental/" target='_blank'>INSTAGRAM</a></div>
        <div className='connect-call'><a href='tel:+381606788761'>POZOVITE</a></div>
